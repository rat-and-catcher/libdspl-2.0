...
int main(int argc, char* argv[])
{
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_32.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_512.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_1024.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_2048.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_4096.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_8192.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_16384.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_32768.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_65536.dat", (void**)(&xc), &nx, &mx, &type);
