...
int main(int argc, char* argv[])
{
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_double_radix2.dat", (void**)(&xd), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_complex_radix2.dat", (void**)(&xc), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_double_common.dat", (void**)(&xd), &nx, &mx, &type);
    ...
    /*------------------------------------------------------------------------*/
    readbin("dat/x_fft_complex_common.dat", (void**)(&xc), &nx, &mx, &type);
